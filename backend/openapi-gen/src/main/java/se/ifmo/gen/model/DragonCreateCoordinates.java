...
@Schema(name = "DragonCreate_coordinates", description = "Either a DragonCreateCoordinates object or an ID reference to existing coordinates")
@JsonTypeName("DragonCreate_coordinates")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.15.0")
public class DragonCreateCoordinates {
  ...
  public DragonCreateCoordinates id(@Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public DragonCreateCoordinates x(@Nullable Float x) {
    this.x = x;
    return this;
  }
  ...
  public DragonCreateCoordinates y(@Nullable Double y) {
    this.y = y;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DragonCreateCoordinates dragonCreateCoordinates = (DragonCreateCoordinates) o;
    return Objects.equals(this.id, dragonCreateCoordinates.id) &&
        Objects.equals(this.x, dragonCreateCoordinates.x) &&
        Objects.equals(this.y, dragonCreateCoordinates.y);
  }
  ...
  public String toString() {
    ...
    sb.append("class DragonCreateCoordinates {\n");
