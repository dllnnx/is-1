...
@Schema(name = "DragonCreate_head", description = "Either a DragonCreateHead object or an ID reference to existing head")
@JsonTypeName("DragonCreate_head")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.15.0")
public class DragonCreateHead {

  private @Nullable Integer id;

  private @Nullable Float toothCount;

  public DragonCreateHead id(@Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public DragonCreateHead toothCount(@Nullable Float toothCount) {
  ...
  public boolean equals(Object o) {
    ...
    DragonCreateHead dragonCreateHead = (DragonCreateHead) o;
    return Objects.equals(this.id, dragonCreateHead.id) &&
        Objects.equals(this.toothCount, dragonCreateHead.toothCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class DragonCreateHead {\n");
