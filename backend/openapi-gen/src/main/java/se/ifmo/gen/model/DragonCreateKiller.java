...
import se.ifmo.gen.model.DragonCreatePerson;
...
@Schema(name = "DragonCreate_killer", description = "Either a DragonCreatePerson object or an ID reference to existing person")
@JsonTypeName("DragonCreate_killer")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.15.0")
public class DragonCreateKiller {
  ...
  public DragonCreateKiller id(@Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public DragonCreateKiller name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public DragonCreateKiller eyeColor(@Nullable Color eyeColor) {
  ...
  public DragonCreateKiller hairColor(Color hairColor) {
  ...
  public DragonCreateKiller location(Location location) {
  ...
  public DragonCreateKiller height(Double height) {
  ...
  public DragonCreateKiller weight(@Nullable Double weight) {
    this.weight = weight;
    return this;
  }
  ...
  public DragonCreateKiller passportID(@Nullable String passportID) {
  ...
  public boolean equals(Object o) {
    ...
    DragonCreateKiller dragonCreateKiller = (DragonCreateKiller) o;
    return Objects.equals(this.id, dragonCreateKiller.id) &&
        Objects.equals(this.name, dragonCreateKiller.name) &&
        Objects.equals(this.eyeColor, dragonCreateKiller.eyeColor) &&
        equalsNullable(this.hairColor, dragonCreateKiller.hairColor) &&
        equalsNullable(this.location, dragonCreateKiller.location) &&
        equalsNullable(this.height, dragonCreateKiller.height) &&
        Objects.equals(this.weight, dragonCreateKiller.weight) &&
        Objects.equals(this.passportID, dragonCreateKiller.passportID);
  }
  ...
  public String toString() {
    ...
    sb.append("class DragonCreateKiller {\n");
