...
class PersonServiceTest {
  ...
  void getAll_ShouldReturnListOfPerson() {
    PersonEntity entity1 = PersonEntity.builder().id(1L).name("John Doe").weight(75.5).build();
    PersonEntity entity2 = PersonEntity.builder().id(2L).name("Jane Smith").weight(65.0).build();
