...
class DragonCaveServiceTest {
  ...
  @InjectMocks private DragonCaveService dragonCaveService;
  ...
  void getAll_ShouldReturnListOfDragonCave() {
    DragonCaveEntity entity1 =
        DragonCaveEntity.builder().id(1L).depth(10.5f).numberOfTreasures(100L).build();
    DragonCaveEntity entity2 =
        DragonCaveEntity.builder().id(2L).depth(20.0f).numberOfTreasures(200L).build();
  ...
  void getCaveWithMaxDepth_WhenCaveExists_ShouldReturnOptionalWithDragonCave() {
    DragonCaveEntity entity =
        DragonCaveEntity.builder().id(1L).depth(50.0f).numberOfTreasures(500L).build();
