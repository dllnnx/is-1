...
class DragonHeadServiceTest {
    ...
    void getAll_WhenRepositoryReturnsSingleEntity_ShouldReturnSingleDragonHead() {
        DragonHeadEntity entity = DragonHeadEntity.builder()
                .id(1L)
                .toothCount(10.5f)
                .build();
    ...
    @Test
    @DisplayName("Should return list with multiple DragonHeads when repository returns multiple entities")
    void getAll_WhenRepositoryReturnsMultipleEntities_ShouldReturnMultipleDragonHeads() {
        DragonHeadEntity entity1 = DragonHeadEntity.builder()
                .id(1L)
                .toothCount(10.5f)
                .build();

        DragonHeadEntity entity2 = DragonHeadEntity.builder()
                .id(2L)
                .toothCount(20.0f)
                .build();

        DragonHeadEntity entity3 = DragonHeadEntity.builder()
                .id(3L)
                .toothCount(15.75f)
                .build();
    ...
    void getAll_ShouldCallRepositoryFindAllExactlyOnce() {
        List<DragonHeadEntity> entityList = List.of(
                DragonHeadEntity.builder().id(1L).toothCount(10.0f).build()
        );
        when(dragonHeadRepository.findAll()).thenReturn(entityList);
