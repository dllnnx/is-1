...
class CoordinatesServiceTest {
  ...
  @InjectMocks private CoordinatesService coordinatesService;
  ...
  void getAll_ShouldReturnListOfCoordinates() {
    CoordinatesEntity entity1 = CoordinatesEntity.builder().id(1L).x(10.5f).y(20.0).build();
    CoordinatesEntity entity2 = CoordinatesEntity.builder().id(2L).x(30.0f).y(40.0).build();
