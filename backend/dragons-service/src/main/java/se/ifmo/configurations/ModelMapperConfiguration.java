...
public class ModelMapperConfiguration {
  ...
  final Converter<DragonCharacter, JsonNullable<DragonCharacter>>
      dragonCharacterFromJsonNullableConverter =
  ...
  final Converter<Integer, JsonNullable<Integer>> integerFromJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<JsonNullable<Integer>, Integer> integerToJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<Double, JsonNullable<Double>> doubleFromJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<JsonNullable<Double>, Double> doubleToJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<Float, JsonNullable<Float>> floatFromJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<JsonNullable<Float>, Float> floatToJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<Long, JsonNullable<Long>> longFromJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<JsonNullable<Long>, Long> longToJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<JsonNullable<String>, String> stringToJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<String, JsonNullable<String>> stringFromJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<JsonNullable<Person>, Person> personToJsonNullableConverter =
      new AbstractConverter<>() {
        @Override
  ...
  final Converter<JsonNullable<DragonCharacter>, DragonCharacter>
      dragonCharacterToJsonNullableConverter =
          new AbstractConverter<>() {
            @Override
  ...
  final Converter<se.ifmo.models.Color, JsonNullable<se.ifmo.gen.model.Color>>
      hairColorToJsonNullable =
          new AbstractConverter<>() {
            @Override
  ...
  public ModelMapper modelMapper() {
    ...
    mapper
        .createTypeMap(DragonEntity.class, Dragon.class)
        .addMappings(
            mapping -> {
              mapping
                  .using(
                      new AbstractConverter<PersonEntity, JsonNullable<Person>>() {
                        @Override
              ...
              mapping
                  .using(
                      new AbstractConverter<
                          se.ifmo.models.DragonCharacter, JsonNullable<DragonCharacter>>() {
                        @Override
                        protected JsonNullable<DragonCharacter> convert(
                            se.ifmo.models.DragonCharacter source) {
                          if (source == null) {
                            return JsonNullable.of(null);
                          }
    ...
    mapper
        .createTypeMap(DragonCreate.class, DragonEntity.class)
        .addMappings(
            mapping -> {
              ...
              mapping
                  .using(
                      new AbstractConverter<
                          JsonNullable<DragonCharacter>, se.ifmo.models.DragonCharacter>() {
                        @Override
                        protected se.ifmo.models.DragonCharacter convert(
                            JsonNullable<DragonCharacter> source) {
    ...
    mapper
        .createTypeMap(
            se.ifmo.gen.model.DragonCreateKiller.class, se.ifmo.models.PersonEntity.class)
        .addMappings(
            mapping -> {
              ...
              mapping
                  .using(
                      new AbstractConverter<
                          JsonNullable<se.ifmo.gen.model.Color>, se.ifmo.models.Color>() {
                        @Override
                        protected se.ifmo.models.Color convert(
                            JsonNullable<se.ifmo.gen.model.Color> source) {
                  ...
                  .map(
                      se.ifmo.gen.model.DragonCreateKiller::getHairColor,
                      se.ifmo.models.PersonEntity::setHairColor);

              mapping
                  .using(
                      new AbstractConverter<
                          JsonNullable<se.ifmo.gen.model.Location>,
                          se.ifmo.models.LocationEntity>() {
                        @Override
                        protected se.ifmo.models.LocationEntity convert(
                            JsonNullable<se.ifmo.gen.model.Location> source) {
                  ...
                  .map(
                      se.ifmo.gen.model.DragonCreateKiller::getLocation,
                      se.ifmo.models.PersonEntity::setLocationEntity);
            });

    mapper
        .createTypeMap(se.ifmo.gen.model.Location.class, se.ifmo.models.LocationEntity.class)
        .addMappings(m -> m.skip(se.ifmo.models.LocationEntity::setId));

    Converter<se.ifmo.models.LocationEntity, JsonNullable<se.ifmo.gen.model.Location>>
        locationToJsonNullable =
            new AbstractConverter<>() {
              @Override
              protected JsonNullable<se.ifmo.gen.model.Location> convert(
                  se.ifmo.models.LocationEntity source) {
                if (source == null) {
                  return JsonNullable.of(null);
                }
                se.ifmo.gen.model.Location dtoLocation =
                    mapper.map(source, se.ifmo.gen.model.Location.class);
                return JsonNullable.of(dtoLocation);
              }
            };
    mapper.addConverter(locationToJsonNullable);
    mapper
        .createTypeMap(LocationEntity.class, Location.class)
