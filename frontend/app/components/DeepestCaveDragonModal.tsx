...
export const DeepestCaveDragonModal = ({ isOpen, onClose }: Props) => {
  ...
  const deepestCaveDragon = useMemo(() => {
    ...
    return allDragonsData.dragons.reduce(
      (max: Dragon | null, dragon: Dragon) => {
    ...
    <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        {!isLoading && !error && !deepestCaveDragon && (
          <div className="text-gray-600">No dragons with caves found.</div>
        )}
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              ...
              {deepestCaveDragon.coordinates && (
                <div className="border-t pt-3">
                  ...
                  <span className="ml-2 text-gray-800">
                    ({deepestCaveDragon.coordinates.x},{' '}
                    {deepestCaveDragon.coordinates.y})
                  </span>
                </div>
              )}
              ...
              {deepestCaveDragon.cave && (
                <div className="border-t pt-3">
                  ...
                  <span className="ml-2 text-gray-800 font-semibold">
                    Depth {deepestCaveDragon.cave.depth},{' '}
                    {deepestCaveDragon.cave.numberOfTreasures} treasures
                  </span>
                </div>
              )}
              ...
              {deepestCaveDragon.head && (
                <div className="border-t pt-3">
                  ...
                  <span className="ml-2 text-gray-800">
                    {deepestCaveDragon.head.toothCount} teeth
                  </span>
                </div>
              )}
