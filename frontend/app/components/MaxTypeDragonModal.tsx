...
export const MaxTypeDragonModal = ({isOpen, onClose}: Props) => {
    const {data: dragon, isLoading, error} = useGetMaxTypeDragonQuery(undefined, {
        skip: !isOpen,
    });
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <span className="ml-2 text-gray-800 font-semibold">{dragon.type}</span>
                                </div>
                                {dragon.character && (
                                    <div>
                                        <span className="text-sm font-semibold text-gray-600">Character:</span>
                                        <span className="ml-2 text-gray-800">{dragon.character}</span>
                                    </div>
                                )}
                            </div>
                            ...
                            {dragon.cave && (
                                <div className="border-t pt-3">
                                    ...
                                    <span className="ml-2 text-gray-800">
                                        Depth {dragon.cave.depth}, {dragon.cave.numberOfTreasures} treasures
                                    </span>
                                </div>
                            )}
                            ...
                            {dragon.killer && (
                                <div className="border-t pt-3">
                                    ...
                                    <span className="ml-2 text-gray-800">{dragon.killer.name}</span>
                                </div>
                            )}
                            ...
                            {dragon.head && (
                                <div className="border-t pt-3">
                                    ...
                                    <span className="ml-2 text-gray-800">{dragon.head.toothCount} teeth</span>
                                </div>
                            )}
