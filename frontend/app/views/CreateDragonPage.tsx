...
export const CreateDragonPage = () => {
  ...
  const [newCoordinates, setNewCoordinates] = useState<
    Partial<DragonCreateCoordinates>
  >({ x: 0, y: 0 });
  const [newCave, setNewCave] = useState<Partial<DragonCreateCave>>({
    depth: 0,
    numberOfTreasures: 0,
  });
  ...
  const [newHead, setNewHead] = useState<Partial<DragonCreateHead>>({
    toothCount: 0,
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await createDragon({ dragonCreate: payload as DragonCreate })
      ...
      .catch((e) => {
        const errorMessage =
          e?.data?.message || e?.message || 'Failed to create dragon';
          ...
          <NestedEntitySelector
            ...
            existingEntitySelect={
              <select
                ...
                onChange={(e) =>
                  handleChange('coordinates', parseInt(e.target.value))
                }
              >
                ...
                <div className="col-span-2">
                  <NestedEntitySelector
                    ...
                    onToggle={() => {
                      ...
                      setNewPerson({
                        ...newPerson,
                        location: createNewPersonLocation
                          ? null
                          : { name: '', x: 0, y: 0 },
                      });
                    }}
                    ...
                    newEntityForm={
                      <div className="space-y-3 p-3 border rounded">
                        <FormInputString
                          ...
                          value={
                            typeof newPerson.location === 'object' &&
                            newPerson.location &&
                            !newPerson.location.id
